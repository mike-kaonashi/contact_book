...
from .helpers.datahelper import TypeEnum, JsonHelper
...
data_helper = JsonHelper(source=DATA_PATH, schema=SCHEMA_PATH)
OUTPUT_FORMAT = None
...
__all__ = ['DATA_PATH', 'SCHEMA_PATH', 'OUTPUT_FORMAT', 'data_helper']
